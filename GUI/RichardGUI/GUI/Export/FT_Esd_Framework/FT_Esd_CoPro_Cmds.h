...
#ifndef _FT_ESD_COPRO_CMDS_H_
#define _FT_ESD_COPRO_CMDS_H_
...
ESD_FUNCTION(Ft_Gpu_CoCmd_Bitmap_Transform, Type = ft_void_t, Category = _GroupHidden)
ESD_PARAMETER(phost, Type = Ft_Gpu_Hal_Context_t *, Default = Ft_Esd_GetHost, Hidden, Internal, Static) // PHOST
...
#endif /* #ifndef _FT_ESD_COPRO_CMDS_H_ */

...
typedef struct { ft_int16_t X, Y; } Ft_Esd_Point16;

ESD_TYPE(Ft_Esd_Size16, Native = Struct) // TODO: Struct support, expose values
typedef struct { ft_int16_t Width, Height; } Ft_Esd_Size16;
...
{ 
	union
	{
		...
		struct { ft_int16_t X, Y; };
	};
	union
	{
		Ft_Esd_Size16 Size;
		struct { ft_int16_t Width, Height; };
	};
} Ft_Esd_Rect16;

ESD_TYPE(Ft_Esd_URect16, Native = Struct) // TODO: Struct support, expose values
typedef struct { ft_uint16_t X, Y, Width, Height; } Ft_Esd_URect16;
ESD_TYPE(Ft_Esd_Rect32, Native = Struct) // TODO: Struct support, expose values
typedef struct { ft_int32_t X, Y, Width, Height; } Ft_Esd_Rect32;
ESD_TYPE(Ft_Esd_URect32, Native = Struct) // TODO: Struct support, expose values
typedef struct { ft_uint32_t X, Y, Width, Height; } Ft_Esd_URect32;

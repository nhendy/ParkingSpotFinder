...
ESD_LOGIC(Ft_Esd_TouchTag, Callback, Include = "Ft_Esd_TouchTag.h", DisplayName = "Touch Tag", Category = EsdUtilities, Icon = ":/icons/hand-point-090.png")
typedef struct
{
	// Callback
	void *Parent;
...
ESD_FUNCTION(Ft_Esd_TouchTag_SuppressCurrentTag, DisplayName = "Suppress Current Tags", Category = EsdUtilities)

...
ESD_WIDGET(Ft_Esd_PushButton, Include = "Ft_Esd_PushButton.h", Callback, DisplayName = "ESD Push Button", Category = EsdWidgets, DefaultSignal = Pushed, Icon = ":/icons/ui-button.png")
typedef struct
{
	void *Parent;
	...
	ESD_INPUT(Width, Type = ft_int16_t, Min = 0, Max = 4096, Default = 120)
	ft_int16_t(* Width)(void *context);
	ESD_INPUT(Height, Type = ft_int16_t, Min = 0, Max = 4096, Default = 36)

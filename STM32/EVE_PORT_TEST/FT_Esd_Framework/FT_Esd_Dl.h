...
{
	Ft_Gpu_Hal_WrCmd32(Ft_Esd_Host, ALPHA_FUNC(func,ref));
}
...
ESD_FUNCTION(Ft_Esd_Dl_RomFont_Setup, Type = ft_uint8_t, DisplayName = "Ft_Esd_Dl_RomFont_Setup", Category = EveRenderFunctions)

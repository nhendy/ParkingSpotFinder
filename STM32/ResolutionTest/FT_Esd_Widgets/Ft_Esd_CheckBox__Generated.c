...
void Ft_Esd_CheckBox_Update(Ft_Esd_CheckBox *context)
{
	...
	ft_uint8_t i = context->Font(owner);
	ft_uint16_t right_3 = Ft_Esd_GetFontHeight(i);
...
{
	void *owner = context->Owner;
	ft_bool_t if_23 = Ft_Esd_TouchTag_Inside(&context->Touch_Tag);
	ft_rgb32_t rgb;
	if (if_23)
	{

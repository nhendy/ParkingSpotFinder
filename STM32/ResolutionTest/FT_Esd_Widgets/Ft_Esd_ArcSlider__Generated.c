...
void Ft_Esd_ArcSlider_Start__Builtin(Ft_Esd_ArcSlider *context)
{
...
{
	void *owner = context->Owner;
	Ft_Esd_ArcSlider_Start__Builtin(context);
	ft_int16_t left_1 = context->Max_Angle;
	ft_int16_t right = context->Value;
	int left = left_1 * right;
	ft_int16_t right_1 = context->MaxValue;
	int set_intial_angle = left / right_1;
...
void Ft_Esd_ArcSlider_Render_Forwarder_ForwardUpdate__Signal(void *c)
{
	Ft_Esd_ArcSlider *context = (Ft_Esd_ArcSlider *)c;
	void *owner = context->Owner;
	ft_int16_t left_3 = context->Angle;
	ft_int16_t right_2 = context->MaxValue;
	int left_2 = left_3 * right_2;
	ft_int16_t right_3 = context->Max_Angle;
	int set_value_from_angle = left_2 / right_3;

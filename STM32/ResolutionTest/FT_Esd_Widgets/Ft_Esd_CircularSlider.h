...
#define Ft_Esd_CircularSlider_CLASSID 0xD98AD4AF
ESD_SYMBOL(Ft_Esd_CircularSlider_CLASSID, Type = esd_classid_t)

ESD_WIDGET(Ft_Esd_CircularSlider, Include = "Ft_Esd_CircularSlider.h", Callback, DisplayName = "ESD Circular Silder", Category = EsdWidgets, X = 1, Y = -2, Width = 801, Height = 481)
typedef struct
{
	union
	{

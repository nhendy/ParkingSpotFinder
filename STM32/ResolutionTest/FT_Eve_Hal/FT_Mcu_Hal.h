...
#if (defined(PANL35) || defined(PANL70) || defined(PANL70PLUS)) && !defined(ESD_SIMULATION)
...
#endif /*(defined(PANL35) || defined(PANL70) || defined(PANL70PLUS)) && !defined(ESD_SIMULATION)*/
